...
<header id="mt-header" class="style3">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 text-right">
                    <ul class="mt-top-list">
                        <li>
                            <a class="hidden" href="<?php echo e(route('shop.show')); ?>">Магазин</a>
                        </li>
                        <li>
    ...
    <div class="mt-bottom-bar">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="mt-logo"><a href="/"><img src="/custom2/img/logo/januya_logo.png" alt="schon"
                                                          style="height: 45px; width: 75px;margin-top: -4px;"></a>
                    </div>
                    <?php $totalPrice = 0;?>
                    <?php $total = 0;?>
                    <?php if(Auth::user()): ?>
                    ...
                    <?php endforeach ?>
                    <?php endif; ?>
                    <a href="<?php echo e(route('basket.show')); ?>" class="mt-sh-cart hidden" id="basket-box">
                    ...
                    <ul class="mt-icon-list">
                        ...
                        <li><a style="color: red;" href="<?php echo e(route('favorite.showUserItem')); ?>"
                               class="icon-heart hidden"><span id="favoriteCount"><?php echo e(count($favorites)); ?></span></a></li>
                    </ul>
                    <nav id="nav">
                        <ul class="hidden">
                            <li>
