    ...
    margin-right: -230px;background-color: #77a100 !important;">
                        ...
                        <div class="tab-content">
                            <div id="tab1">
                                <div class="tabs-sliderlg">
                                    <?php $__currentLoopData = $elixirs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <div class="slide">
                                            <div class="mt-product1 large">
                                                ...
                                                <div class="txt">
                                                    <strong class="title"><a
                                                                href="<?php echo e(route('product.detail',$product->product_id, ['id' => $product->product_id])); ?>"><?php echo e($product->product_name_ru); ?></a></strong>
                                                    <p><?php echo e($product->product_desc_ru); ?></p>
                                                    <span class="price"><i
                                                                class="fa fa-dollar"></i> <span><?php echo e($product->product_price); ?>

                                                               (<?php echo e($product->product_price * (\App\Models\Currency::where(['currency_id' => 1 ])->first())->money); ?>   &#8376;) </span></span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="tab2">
                                <div class="tabs-sliderlg">
                                    <?php $__currentLoopData = $sprays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <div class="slide">
                                            <div class="mt-product1 large">
                                                <div class="box">
                                                    <div class="b1">
                            ...
                            <div id="tab3">
                                <div class="tabs-sliderlg">
                                    <?php $__currentLoopData = $gels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <div class="slide">
                                            <div class="mt-product1 large">
                                                <div class="box">
                                                    <div class="b1">
                            ...
                            <div id="tab4">
                                <div class="tabs-sliderlg">
                                    <?php $__currentLoopData = $creams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <div class="slide">
                                            <div class="mt-product1 large">
                                                <div class="box">
                                                    <div class="b1">
                    ...
                    <div class="mt-producttabs style3 wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="tabs-slider">
                            <?php $__currentLoopData = $popularProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <div class="slide">
                                    <div class="mt-product1">
                                        <div class="box">
                                            <div class="b1">
                                                <div class="b2">
                                                    <div style="background-position: center; background-size: cover; width: 215px; height: 215px; background-image: url('<?php echo e($product->product_image); ?>')">
                                                    </div>
                                                    <span class="caption">
                                        ...
                                        <div class="txt">
                                            <strong class="title"><a
                                                        href="<?php echo e(route('product.detail',$product->product_id, ['id' => $product->product_id])); ?>"><?php echo e($product->product_name); ?></a></strong>
                                            <span class="price"><i
                                                        class="fa fa-dollar"></i> <span><?php echo e($product->product_price); ?></span> 	(<?php echo e($product->product_price * (\App\Models\Currency::where(['currency_id' => 1])->first())->money); ?> &#8376;)</span>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
