                    ...
                    <table id="packet_datatable" class="table table-bordered table-striped">
                        ...
                        <?php $__currentLoopData = $row->basket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($val['product_price']); ?>pv (<?php echo e(round($val->product_price * \App\Models\Currency::PVtoKzt,2)); ?>тг)
                                </td>
                                <td>
                                    <?php echo e($val['unit']); ?>
                        ...
                        <tr>
                            ...
                            <td colspan="1"><b id="sum"><?php echo e($sum); ?>$ (<?php echo e(round($sum * \App\Models\Currency::PVtoKzt,2)); ?>тг)</b></td>
                        </tr>
