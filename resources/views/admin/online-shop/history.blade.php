                    ...
                    <table id="packet_datatable" class="table table-bordered table-striped">
                        ...
                        @foreach($row->basket as $key => $val)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $val['product_price']}}pv ({{round($val->product_price * \App\Models\Currency::PVtoKzt,2)}}тг)
                                </td>
                                <td>
                                    {{ $val['unit']}}
                                </td>
                        ...
                        <tr>
                            ...
                            <td colspan="1"><b id="sum">{{$sum}}$ ({{round($sum * \App\Models\Currency::PVtoKzt,2)}}тг)</b></td>
                        </tr>
