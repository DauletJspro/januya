        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title box-title-first">
                        <a href="/admin/vip_client?is_active=0"
                           class="menu-tab @if(isset($request->is_active)) active-page @endif">Ожидаемые
                            пользователи</a>
                    </h3>
                    <h3 class="box-title box-title-second">
                        <a href="/admin/vip_client?is_ban=1"
                           class="menu-tab @if($request->is_ban == '1') active-page @endif">Не актуальные
                            пользователи</a>
                    </h3>                    
