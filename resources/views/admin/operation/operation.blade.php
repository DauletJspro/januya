                                    ...
                                    <table id="news_datatable" class="table table-bordered table-striped table-css">
                                        ...
                                        @foreach($row as $key => $val)
                                            ...
                                            <tr @if($val->operation_type_id == 10) style="background-color: #91ff91 !important;" @endif>
                                                ...
                                                <td class="arial-font">
                                                    {{ mb_convert_encoding($val->operation_type_name_ru,"UTF-8","auto") }} @if($val->operation_type_id == 9)
                                                        "{{ mb_convert_encoding($val->fond_name_ru, "UTF-8","auto") }}" @endif
                                                </td>
                                                <td class="arial-font">
                                                    {{ mb_convert_encoding($val->operation_name_ru, "UTF-8","auto") }}
                                                </td>
                                                <td class="arial-font">
