                  ...
                  @foreach($row as $key => $val)
                     ...
                     <tr>
                        <td> {{ $key + 1 }}</td>
                         ...
                         <td>
                             {{$val->money*0.9}} $ ({{round($val->money *0.9* \App\Models\Currency::where('currency_name','dollar')->first()->dollar,2)}}тг)
                         </td>
                         <td>
                             {{$val->money*0.1}} $ ({{round($val->money *0.1* \App\Models\Currency::where('currency_name','dollar')->first()->dollar,2)}}тг)
                         </td>
                        <td>
                            {{ $val->date }}
                        </td>
